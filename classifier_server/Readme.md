...
```
git clone https://github.com/ruchira-patil/Classifier-API.git
```

2. Navigate to the project directory:

```
cd Classifier-API/classifier_server
```
...
Ruchira Dayanand Patil is a Software Developer with over 5 years of professional experience in software engineering. With expertise in Python, Java, and RESTful API development, Ruchira focuses on building efficient and scalable technical solutions.
